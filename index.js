...
const getWordDataFromApi = (word) => {
  return new Promise(resolve => needle.get(`https://dictionary.yandex.net/api/v1/dicservice.json/lookup?key=${APIkey}&lang=en-en&text=${word}`, function(error, response) {
